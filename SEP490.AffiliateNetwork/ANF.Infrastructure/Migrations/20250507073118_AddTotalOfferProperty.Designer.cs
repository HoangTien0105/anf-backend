...
namespace ANF.Infrastructure.Migrations
{
    ...
    [Migration("20250507073118_AddTotalOfferProperty")]
    partial class AddTotalOfferProperty
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ANF.Core.Models.Entities.AdvertiserCampaignStats", b =>
                {
                    ...
                    b.Property<decimal>("TotalBudgetSpent")
                        ...
                        .HasColumnName("total_budget_spent");

                    b.Property<int>("TotalClick")
                        .HasColumnType("int")
                        .HasColumnName("total_click");

                    b.Property<int>("TotalComputer")
                        .HasColumnType("int")
                        .HasColumnName("total_computer");

                    b.Property<int>("TotalFraudClick")
                        .HasColumnType("int")
                        .HasColumnName("total_fraud_click");

                    b.Property<int>("TotalJoinedPublisher")
                        .HasColumnType("int")
                        .HasColumnName("total_joined_publisher");

                    b.Property<int>("TotalMobile")
                        .HasColumnType("int")
                        .HasColumnName("total_mobile");

                    b.Property<int>("TotalOffer")
                        .HasColumnType("int")
                        .HasColumnName("total_offer");

                    b.Property<int>("TotalRejectedPublisher")
                        .HasColumnType("int")
                        .HasColumnName("total_rejected_publisher");

                    b.Property<int>("TotalTablet")
                        .HasColumnType("int")
                        .HasColumnName("total_tablet");

                    b.Property<int>("TotalVerifiedClick")
                        .HasColumnType("int")
                        .HasColumnName("total_verified_click");

                    b.HasKey("Id");

                    b.ToTable("AdvertiserCampaignStats", (string)null);
                });
            ...
            modelBuilder.Entity("ANF.Core.Models.Entities.ComplaintTicket", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("ComplaintTicket");
                });

            modelBuilder.Entity("ANF.Core.Models.Entities.ComplaintType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ANF.Core.Models.Entities.PublisherCampaignStats", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("PublisherCampaignStats", (string)null);
                });
            ...
            modelBuilder.Entity("ANF.Core.Models.Entities.PublisherProfile", b =>
                {
                    ...
                    b.Property<string>("NoOfExperience")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("no_of_experience");
            ...
            modelBuilder.Entity("ANF.Core.Models.Entities.PurchaseLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("ANF.Core.Models.Entities.Subscription", b =>
                {
                    ...
                    b.Property<int>("MaxCreatedCampaign")
                        .HasColumnType("int")
                        .HasColumnName("max_created_campaign");
                    ...
                    b.Property<string>("PricingBenefit")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("pricing_benefit");
            ...
            modelBuilder.Entity("ANF.Core.Models.Entities.Transaction", b =>
                {
                    ...
                    b.Property<bool>("IsWithdrawal")
                        .HasColumnType("bit")
                        .HasColumnName("is_withdrawal");

                    b.Property<string>("Reason")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("reason");

                    b.Property<int?>("RemainedSlot")
                        .HasColumnType("int")
                        .HasColumnName("remained_slot");
            ...
            modelBuilder.Entity("ANF.Core.Models.Entities.ComplaintTicket", b =>
                {
                    b.HasOne("ANF.Core.Models.Entities.ComplaintType", "Type")
