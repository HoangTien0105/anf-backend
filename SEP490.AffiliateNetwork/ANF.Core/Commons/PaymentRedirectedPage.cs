namespace ANF.Core.Commons
{
    public class PaymentRedirectedPage
    {
        ...
        /// <summary>
        /// URL to redirect to after publisher request to join an offer for advertiser
        /// </summary>
        public const string OfferRedirectPageForAdvertiser = "https://dev.l3on.id.vn/advertiser/campaigns/{0}/offers/{1}";

        /// <summary>
        /// URL to redirect to after advertiser accepted request to join an offer for publisher
        /// </summary>
